               ...
               <li class="items">
                   ...
                   <div  class="w_260">
                       <div class="goumai">
                           ...
                           <a href="<?= \yii\helpers\Url::to(['/train/certificate','id'=>$data['type']])?>" class="goumai02">立即购买</a>
                       </div>
                   </div>
               </li>
           </ul>
...
<div class="w_1200 store1_bottom">
    ...
    <div class="goumai">
        合计：<i>¥ <span id="total">0</span></i><a href="" class="goumai01">放入购物车</a><a href="<?= \yii\helpers\Url::to(['/train/certificate','id'=>$data['type']])?>" class="goumai02">立即购买</a>
    </div>
</div>
