...
INSERT INTO `yii2_menu` VALUES ('140', '帆船培训', '2', '50', 'train/index?type=1', '0', '培训管理|icon-headphones', '1');
...
INSERT INTO `yii2_menu` VALUES ('149', '潜水排序', '2', '51', 'train/index?type=2', '0', '培训管理|icon-headphones', '1');
...
-- ----------------------------
INSERT INTO `yii2_order` VALUES ('1', '135555111', '6', 'shop', '1', '商品名称', '1345678940', '1345688940', '1', '0', '1345668940', '1', '1', '1345678940', '1');
...
CREATE TABLE `yii2_shop` (
  ...
  PRIMARY KEY (`id`),
  KEY `type` (`type`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='酒店表';

-- ----------------------------
-- Records of yii2_shop
-- ----------------------------
INSERT INTO `yii2_shop` VALUES ('1', '1', '大床双人房特价', '111111', '/upload/image/201608/1472638058196.jpg,/upload/image/201608/1472638060470.jpg', '111', '520.12', 'a:3:{i:111;s:3:\"111\";i:222;s:3:\"222\";i:333;s:3:\"333\";}', '1', '1472638475', '1472638731', '1');
...
CREATE TABLE `yii2_shop_group` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='套餐设置';

-- ----------------------------
-- Records of yii2_shop_group
-- ----------------------------
INSERT INTO `yii2_shop_group` VALUES ('1', '测试商品套餐1', '1,2', '150.00', '0', '1');
...
-- ----------------------------
INSERT INTO `yii2_train` VALUES ('1', '1', '测试培训标题1', '是飞洒发送', '523.23', '127', '0', '1472643081', '1473611906', '1');
INSERT INTO `yii2_train` VALUES ('2', '2', '测试培训标题', '测试培训描述', '231.12', '100', '1', '1472643186', '1472643217', '1');
INSERT INTO `yii2_train` VALUES ('3', '1', '帆船培训2', '帆船培训2', '322.20', '1', '0', '1473611927', null, '1');
INSERT INTO `yii2_train` VALUES ('4', '1', '帆船培训3', '帆船培训3', '222.22', '122', '0', '1473611964', null, '1');
INSERT INTO `yii2_train` VALUES ('5', '2', '潜水培训2', '潜水培训2', '100.02', '100', '0', '1473612010', null, '1');
INSERT INTO `yii2_train` VALUES ('6', '2', '潜水培训3', '潜水培训3', '123.23', '100', '0', '1473612026', null, '1');
...
-- ----------------------------
INSERT INTO `yii2_train_type` VALUES ('1', '帆船培训');
INSERT INTO `yii2_train_type` VALUES ('2', '潜水培训');
...
-- ----------------------------
INSERT INTO `yii2_user` VALUES ('6', 'e282486518', '$2y$13$oO.xRlrKjMMF/bykb7476.zBIH2RkR6rtv8j5jrYgSxi71AvV3lFG', 'kXGkWeNSeoK7vakqRfUAviocq-5uy0cN', 'phphome@qq.com', '13656568989', '1456568652', '13654444444', '1456568652', '13556464888', '1473605683', '/upload/image/201609/1473605673521.png', '10', '0', '1');
INSERT INTO `yii2_user` VALUES ('7', '282486518', '$2y$13$KIAenVWuR2Tgi1VCKiPegeVsQAHXyDcp9rUmzhqK6TNjL4Cqc3YPa', 'n9uguceYCqn_jQNd8F6-JRHOj21yltUo', 'phphome@qq.coms', '13645685421', '1472626509', '2130706433', '0', '2130706433', '1472626719', '/upload/image/201608/1472626502486.jpg', '1', '1', '0');
