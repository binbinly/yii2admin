...
--
-- Host: localhost
-- Generation Time: 2016-09-21 10:51:53
-- 服务器版本： 5.5.48-log
-- PHP Version: 5.5.36
...
(1, 1, '测试广告1', '/upload/image/201608/1472644398807.jpg', 'http://www.imhaigui.com', 1, 1);
...
(1, 'admin', '$2y$13$YHruPeQ9VhT5LjuglzimHOqYyJf8SJitk80ADzshTjCzsb4yWcqCm', 'JSCZQ2Oh4FrAOEyPjJgIUdfbXklO6kve', 'phphome111@qq.com', '13565231111', 1457922160, 2130706433, 1457922174, 2130706433, 1472817209, 1),
...
(4, 'testuser', '$2y$13$fac8CDeuFI7rm318MKULLexCKrk1r4jsr56MNiVshvtnZLQYBQ0dq', '30O_rRLz-fNKULFrc0OH4osPhuIzikwT', 'php2222@qq.com', '12345651111', 1459934783, 2130706433, 0, 2130706433, 1460032029, 1);
...
(3, 1, 'jieshao', '帆海汇介绍', '', '帆海汇介绍', '<p><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span><span style="color: rgb(34, 34, 34); font-family: Consolas, &#39;Lucida Console&#39;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">帆海汇介绍</span></p>', '', 2, 0, '', 0, 1473606822, 0, 1),
...
('administrator', 1, 'administrator角色12', '', '', 1465352150, 1460005083),
...
('editor', 1, 'editor 网站编辑角色', '', '', 1356232000, 1400000000),
...
('administrator', 'Addons/addHook'),
('administrator', 'Addons/adminList'),
('administrator', 'Addons/edithook'),
('administrator', 'Addons/execute'),
('administrator', 'Addons/hooks'),
...
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='验证码表';
...
(1, 0, 'about', '关于我们', '0', '', '', '', '', 1379474947, 1473604610, 0, 1),
...
(1, 'WEB_SITE_TITLE', '网站标题', 1, 1, '内容管理框架', '', '网站标题前台显示标题', 1378898976, 1472528403, 0, 1),
...
(11, 'DATA_BACKUP_PATH', '数据库备份路径', 4, 1, './data/', '', '路径必须以 / 结尾', 1379053380, 1469071721, 3, 1),
...
(3, '文章管理', 2, 1, 'article/index', 0, '文章管理|icon-edit', 1),
...
(139, '潜水管理', 2, 22, 'shop/index?type=3', 0, '商城管理|icon-glass', 1),
...
(144, '商城套餐', 2, 29, 'group/index', 0, '商城管理|icon-glass', 1),
...
(44, '订单列表', 43, 1, 'order/index', 0, '订单管理|icon-cny', 1),
(143, '海钓管理', 2, 23, 'shop/index?type=4', 0, '商城管理|icon-glass', 1),
(142, '前台用户', 16, 20, 'user/index', 0, '前台用户|icon-user-md', 1),
(141, '帆船管理', 2, 21, 'shop/index?type=2', 0, '商城管理|icon-glass', 1),
(140, '帆船培训', 2, 50, 'train/index?type=1', 0, '培训管理|icon-headphones', 1),
...
(69, '网站设置', 68, 1, 'config/group', 0, '系统设置|icon-legal', 1),
(70, '配置管理', 68, 1, 'config/index', 0, '系统设置|icon-legal', 1),
(71, '编辑', 70, 0, 'config/edit', 0, '', 1),
(72, '删除', 70, 0, 'config/del', 0, '', 1),
(73, '新增', 70, 0, 'config/add', 0, '', 1),
(74, '保存', 70, 0, 'config/save', 0, '', 1),
(75, '菜单管理', 68, 5, 'menu/index', 0, '系统设置|icon-legal', 1),
(80, '分类管理', 2, 2, 'category/index', 0, '文章管理|icon-edit', 1),
...
(86, '备份数据库', 68, 10, 'database/index?type=export', 0, '数据备份|icon-apple', 1),
(87, '备份', 86, 0, 'database/export', 0, '', 1),
(88, '优化表', 86, 0, 'database/optimize', 0, '', 1),
(89, '修复表', 86, 0, 'database/repair', 0, '', 1),
(90, '还原数据库', 68, 11, 'database/index?type=import', 0, '数据备份|icon-apple', 1),
...
(149, '潜水排序', 2, 51, 'train/index?type=2', 0, '培训管理|icon-headphones', 1),
(138, '酒店管理', 2, 20, 'shop/index?type=1', 0, '商城管理|icon-glass', 1),
(119, '排序', 70, 0, 'Config/sort', 1, '', 1),
(120, '排序', 75, 0, 'Menu/sort', 1, '', 1),
(129, '用户授权', 17, 0, 'admin/auth', 0, '', 0),
(131, '待完成任务', 1, 0, 'index/index', 0, '任务列表', 0),
(158, '删除培训', 2, 0, 'train/delete', 1, '', 1),
(159, '广告管理', 2, 0, 'ad/index', 0, '广告管理|icon-comment', 1),
...
(5, '1474094023', 0, '', '', '', 'shop', 1, '大床双人房特价', 1473345000, 0, 1, 0, 1474094023, 4, 3, 1474094061, 1);
...
(3, 1, '测试酒店1', '测试酒店1', '/upload/image/201609/1473947265806.jpg', '/upload/image/201609/1473947288984.jpg,/upload/image/201609/1473947290715.jpg', 4, '420.23', 'a:1:{s:3:"sss";s:5:"sadfa";}', 0, 1473835350, 1473947292, 1),
(4, 2, '测试帆船标题', '测试商品描述测试商品描述测试商品描述测试商品描述测试商品描述', '/upload/image/201609/1474176209742.jpg', '/upload/image/201609/1474176211761.jpg,/upload/image/201609/1474176213249.jpg,/upload/image/201609/1474176215379.jpg', 111, '333.00', 'a:1:{i:0;s:0:"";}', 0, 1474176248, NULL, 1),
...
(1, '测试商品套餐1', '商品描述商品描述商品描述商品描述商品描述', 'a:1:{i:4;a:1:{i:2;a:3:{s:4:"days";s:2:"30";s:3:"num";s:2:"30";s:2:"id";s:1:"2";}}}', '550.00', 0, 1),
...
INSERT INTO `yii2_train` (`id`, `type`, `title`, `description`, `price`, `num`, `sort`, `create_time`, `update_time`, `status`) VALUES
(1, 1, '测试培训标题1', '是飞洒发送', '523.23', 127, 0, 1472643081, 1473611906, 1),
(2, 2, '测试培训标题', '测试培训描述', '231.12', 100, 1, 1472643186, 1472643217, 1),
(3, 1, '帆船培训2', '帆船培训2', '322.20', 1, 0, 1473611927, NULL, 1),
(4, 1, '帆船培训3', '帆船培训3', '222.22', 122, 0, 1473611964, NULL, 1),
(5, 2, '潜水培训2', '潜水培训2', '100.02', 100, 0, 1473612010, NULL, 1),
(6, 2, '潜水培训3', '潜水培训3', '123.23', 100, 0, 1473612026, NULL, 1);
...
INSERT INTO `yii2_train_type` (`id`, `name`) VALUES
(1, '帆船培训'),
(2, '潜水培训');
...
(13, 'aabbcc', '$2y$13$s0AIh8TnQOUXxLh7h7WbZeqGwJZxhV0jBrmZXsDjHxaIYyYdVB8O2', '02vrdPnk2HU0u-fqgkcH7qQabVpquk7M', NULL, '13421839870', 1474114459, 2130706433, 0, 2130706433, 0, 0, '', 0, 0, 1),
...
--
ALTER TABLE `yii2_admin`
  MODIFY `uid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户ID',AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `yii2_menu`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',AUTO_INCREMENT=163;
--
...
--
ALTER TABLE `yii2_user`
  MODIFY `uid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户ID',AUTO_INCREMENT=19;
--
