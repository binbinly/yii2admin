...
return [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'showScriptName' => true,  //是否显示链接中的index.php
            //'suffix' => '.html', //后缀
            'rules' => [
                //
            ],
    ...
    'controllerMap' => [
        ...
        'ueditor' => [
            ...
            'config' => [
                ...
                'imagePathFormat'      => '/upload/image/{yyyy}{mm}/{time}{rand:6}',
                'scrawlPathFormat'     => '/upload/image/{yyyy}{mm}/{time}{rand:6}',
                'snapscreenPathFormat' => '/upload/image/{yyyy}{mm}/{time}{rand:6}',
                'catcherPathFormat'    => '/upload/image/{yyyy}{mm}/{time}{rand:6}',
                'videoPathFormat'      => '/upload/video/{yyyy}{mm}/{time}{rand:6}',
                'filePathFormat'       => '/upload/file/{yyyy}{mm}/{rand:4}_{filename}',
