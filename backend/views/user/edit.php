...
<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    <i class="icon-lock"></i>
                    <input type="password" class="m-wrap " name="User[password]" placeholder="密码不变请留空" />
                </div>
            </div>
        </div>
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="input-append">
                        ...
                        <span class="btn btn-file">
                            ...
                            <input type="hidden" name="User[image]" id="file_ipt" value="<?=$model->image?>">
                        </span>
        ...
        <?=$form->field($model, 'score')->textInput(['class'=>'span1 m-wrap'])->label('当前积分')->hint('可用于积分消费')?>
        
        <?=$form->field($model, 'score_all')->textInput(['class'=>'span1 m-wrap'])->label('总积分')->hint('消费积分时，总积分不会变')?>
