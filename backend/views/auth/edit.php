...
<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="<?=\yii\helpers\Url::toRoute(['edit','role'=>$role->name])?>" method="post" class="form-aaa form-horizontal form-bordered form-row-stripped">

            <div class="control-group">
                <label class="control-label">角色名</label>
                <div class="controls">
                    <input type="text" class="span3 m-wrap" name="param[name]" value="<?=$role->name?>"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="param[description]" class="large m-wrap" rows="3"><?=$role->description?></textarea>
                </div>
            </div>
